    ...
    public class Db : Core.Db.Db
    {
        ...
        public Db(string connectionString) : base(connectionString)
        {
            ...
            foreach (var part in connectionStringParts)
            {
                if (!string.IsNullOrEmpty(part.Trim()))
                {
                    ...
                    {
                        _port = int.Parse(connPart.Replace("PORT=", string.Empty));
                    }
                    else if (connPart.StartsWith("USER="))
                    {
                        _user = connPart.Replace("USER=", string.Empty);
                    }
                    ...
                    {
                        _database = connPart.Replace("DATABASE=", string.Empty);
                    }
                }
            }
            ...
            _helper.CreateDatabaseIfNotExists(_server, _port, _user, _password, _database);
        ...
        public override void Init()
        {
            ...
            using (var conn = new MySqlConnection(_connectionString))
            {
                ...
                var command = new MySqlCommand("INSERT INTO " + Core.Db.StatusCount.DocumentName + "("
            ...
            using (var conn = new MySqlConnection(_connectionString))
            {
                ...
                var command = new MySqlCommand("SELECT COUNT(*) FROM " + Core.Db.User.DocumentName + ";", conn);
        ...
        public override bool CheckUserWorkflow(string userId, string workflowId)
        {
            using (var conn = new MySqlConnection(_connectionString))
            {
                ...
                var command = new MySqlCommand("SELECT COUNT(*) FROM " + Core.Db.UserWorkflow.DocumentName
        ...
        public override void ClearEntries()
        {
            using (var conn = new MySqlConnection(_connectionString))
            {
                ...
                var command = new MySqlCommand("DELETE FROM " + Core.Db.Entry.DocumentName + ";", conn);
        ...
        public override void ClearStatusCount()
        {
            using (var conn = new MySqlConnection(_connectionString))
            {
                ...
                var command = new MySqlCommand("DELETE FROM " + Core.Db.StatusCount.DocumentName + ";", conn);
        ...
        public override void DecrementPendingCount()
        {
            using (var conn = new MySqlConnection(_connectionString))
            {
                ...
                var command = new MySqlCommand("SELECT " + StatusCount.ColumnName_PendingCount + " FROM " + Core.Db.StatusCount.DocumentName + ";", conn);

                var count = (int)command.ExecuteScalar();

                count--;

                command = new MySqlCommand("UPDATE " + Core.Db.StatusCount.DocumentName + " SET " + StatusCount.ColumnName_PendingCount + " = " + count + ";", conn);
        ...
        public override void DecrementRunningCount()
        {
            using (var conn = new MySqlConnection(_connectionString))
            {
                ...
                var command = new MySqlCommand("SELECT " + StatusCount.ColumnName_RunningCount + " FROM " + Core.Db.StatusCount.DocumentName + ";", conn);

                var count = (int)command.ExecuteScalar();

                count--;

                command = new MySqlCommand("UPDATE " + Core.Db.StatusCount.DocumentName + " SET " + StatusCount.ColumnName_RunningCount + " = " + count + ";", conn);
        ...
        public override void DeleteUser(string username, string password)
        {
            using (var conn = new MySqlConnection(_connectionString))
            {
                ...
                var command = new MySqlCommand("DELETE FROM " + Core.Db.User.DocumentName
        ...
        public override void DeleteUserWorkflowRelationsByUserId(string userId)
        {
            using (var conn = new MySqlConnection(_connectionString))
            {
                ...
                var command = new MySqlCommand("DELETE FROM " + Core.Db.UserWorkflow.DocumentName
        ...
        public override void DeleteWorkflow(string id)
        {
            using (var conn = new MySqlConnection(_connectionString))
            {
                ...
                var command = new MySqlCommand("DELETE FROM " + Core.Db.Workflow.DocumentName
        ...
        public override IEnumerable<Core.Db.User> GetAdministrators(string keyword, UserOrderBy uo)
        {
            ...
            using (var conn = new MySqlConnection(_connectionString))
            {
                ...
                var command = new MySqlCommand("SELECT " + User.ColumnName_Id + ", "
        ...
        public override IEnumerable<Core.Db.Entry> GetEntries(string keyword, DateTime from, DateTime to, int page, int entriesCount, EntryOrderBy eo)
        {
            ...
            using (var conn = new MySqlConnection(_connectionString))
            {
                ...
                var command = new MySqlCommand(sqlBuilder.ToString(), conn);
        ...
        public override DateTime GetEntryStatusDateMax()
        {
            using (var conn = new MySqlConnection(_connectionString))
            {
                ...
                var command = new MySqlCommand("SELECT " + Entry.ColumnName_StatusDate
                    + " FROM " + Core.Db.Entry.DocumentName
        ...
        public override DateTime GetHistoryEntryStatusDateMax()
        {
            using (var conn = new MySqlConnection(_connectionString))
            {
                ...
                var command = new MySqlCommand("SELECT " + HistoryEntry.ColumnName_StatusDate
                    + " FROM " + Core.Db.HistoryEntry.DocumentName
        ...
        public override string GetPassword(string username)
        {
            using (var conn = new MySqlConnection(_connectionString))
            {
                ...
                var command = new MySqlCommand("SELECT " + User.ColumnName_Password
                    + " FROM " + Core.Db.User.DocumentName
                    + " WHERE " + User.ColumnName_Username + " = '" + username + "'"
                    + ";", conn);
        ...
        public override Core.Db.StatusCount GetStatusCount()
        {
            using (var conn = new MySqlConnection(_connectionString))
            {
                ...
                var command = new MySqlCommand("SELECT " + StatusCount.ColumnName_Id + ", "
                    + StatusCount.ColumnName_PendingCount + ", "
                    + StatusCount.ColumnName_RunningCount + ", "
                    + StatusCount.ColumnName_DoneCount + ", "
                    + StatusCount.ColumnName_FailedCount + ", "
        ...
        public override IEnumerable<string> GetUserWorkflows(string userId)
        {
            ...
            using (var conn = new MySqlConnection(_connectionString))
            {
                ...
                var command = new MySqlCommand("SELECT " + UserWorkflow.ColumnName_Id + ", "
        ...
        public override Core.Db.Workflow GetWorkflow(string id)
        {
            using (var conn = new MySqlConnection(_connectionString))
            {
                ...
                var command = new MySqlCommand("SELECT " + Workflow.ColumnName_Id + ", "
        ...
        public override void IncrementDisabledCount()
        {
            using (var conn = new MySqlConnection(_connectionString))
            {
                ...
                var command = new MySqlCommand("SELECT " + StatusCount.ColumnName_DisabledCount + " FROM " + Core.Db.StatusCount.DocumentName + ";", conn);

                var count = (int)command.ExecuteScalar();

                count++;

                command = new MySqlCommand("UPDATE " + Core.Db.StatusCount.DocumentName + " SET " + StatusCount.ColumnName_DisabledCount + " = " + count + ";", conn);
        ...
        public override void IncrementDoneCount()
        {
            using (var conn = new MySqlConnection(_connectionString))
            {
                ...
                var command = new MySqlCommand("SELECT " + StatusCount.ColumnName_DoneCount + " FROM " + Core.Db.StatusCount.DocumentName + ";", conn);

                var count = (int)command.ExecuteScalar();

                count++;

                command = new MySqlCommand("UPDATE " + Core.Db.StatusCount.DocumentName + " SET " + StatusCount.ColumnName_DoneCount + " = " + count + ";", conn);
        ...
        public override void IncrementFailedCount()
        {
            using (var conn = new MySqlConnection(_connectionString))
            {
                ...
                var command = new MySqlCommand("SELECT " + StatusCount.ColumnName_FailedCount + " FROM " + Core.Db.StatusCount.DocumentName + ";", conn);

                var count = (int)command.ExecuteScalar();

                count++;

                command = new MySqlCommand("UPDATE " + Core.Db.StatusCount.DocumentName + " SET " + StatusCount.ColumnName_FailedCount + " = " + count + ";", conn);
        ...
        public override void IncrementStoppedCount()
        {
            using (var conn = new MySqlConnection(_connectionString))
            {
                ...
                var command = new MySqlCommand("SELECT " + StatusCount.ColumnName_StoppedCount + " FROM " + Core.Db.StatusCount.DocumentName + ";", conn);

                var count = (int)command.ExecuteScalar();

                count++;

                command = new MySqlCommand("UPDATE " + Core.Db.StatusCount.DocumentName + " SET " + StatusCount.ColumnName_StoppedCount + " = " + count + ";", conn);
        ...
        public override void IncrementWarningCount()
        {
            using (var conn = new MySqlConnection(_connectionString))
            {
                ...
                var command = new MySqlCommand("SELECT " + StatusCount.ColumnName_WarningCount + " FROM " + Core.Db.StatusCount.DocumentName + ";", conn);

                var count = (int)command.ExecuteScalar();

                count++;

                command = new MySqlCommand("UPDATE " + Core.Db.StatusCount.DocumentName + " SET " + StatusCount.ColumnName_WarningCount + " = " + count + ";", conn);
        ...
        public override void InsertEntry(Core.Db.Entry entry)
        {
            using (var conn = new MySqlConnection(_connectionString))
            {
                ...
                var command = new MySqlCommand("INSERT INTO " + Core.Db.Entry.DocumentName + "("
                    + Entry.ColumnName_Name + ", "
                    + Entry.ColumnName_Description + ", "
                    + Entry.ColumnName_LaunchType + ", "
                    + Entry.ColumnName_StatusDate + ", "
        ...
        public override void InsertHistoryEntry(Core.Db.HistoryEntry entry)
        {
            using (var conn = new MySqlConnection(_connectionString))
            {
                ...
                var command = new MySqlCommand("INSERT INTO " + Core.Db.HistoryEntry.DocumentName + "("
                    + HistoryEntry.ColumnName_Name + ", "
                    + HistoryEntry.ColumnName_Description + ", "
                    + HistoryEntry.ColumnName_LaunchType + ", "
                    + HistoryEntry.ColumnName_StatusDate + ", "
        ...
        public override void InsertUser(Core.Db.User user)
        {
            using (var conn = new MySqlConnection(_connectionString))
            {
                ...
                var command = new MySqlCommand("INSERT INTO " + Core.Db.User.DocumentName + "("
                    + User.ColumnName_Username + ", "
                    + User.ColumnName_Password + ", "
                    + User.ColumnName_UserProfile + ", "
                    + User.ColumnName_Email + ", "
        ...
        public override void InsertUserWorkflowRelation(Core.Db.UserWorkflow userWorkflow)
        {
            using (var conn = new MySqlConnection(_connectionString))
            {
                ...
                var command = new MySqlCommand("INSERT INTO " + Core.Db.UserWorkflow.DocumentName + "("
                    + UserWorkflow.ColumnName_UserId + ", "
        ...
        public override string GetEntryLogs(string entryId)
        {
            using (var conn = new MySqlConnection(_connectionString))
            {
                ...
                var command = new MySqlCommand("SELECT " + Entry.ColumnName_Logs
                    + " FROM " + Core.Db.Entry.DocumentName
                    + " WHERE "
        ...
        public override string GetHistoryEntryLogs(string entryId)
        {
            using (var conn = new MySqlConnection(_connectionString))
            {
                ...
                var command = new MySqlCommand("SELECT " + HistoryEntry.ColumnName_Logs
                    + " FROM " + Core.Db.HistoryEntry.DocumentName
                    + " WHERE "
