    ...
    public class Db : Core.Db.Db
    {
        ...
        public override void DecrementPendingCount()
        {
            using (var conn = new FbConnection(_connectionString))
            {
                ...
                using (var command1 = new FbCommand("SELECT " + StatusCount.ColumnName_PendingCount + " FROM " + Core.Db.StatusCount.DocumentName + ";", conn))
                {
                    ...
                    using (var command2 = new FbCommand("UPDATE " + Core.Db.StatusCount.DocumentName + " SET " + StatusCount.ColumnName_PendingCount + " = " + count + ";", conn))
                    {
        ...
        public override void DecrementRunningCount()
        {
            using (var conn = new FbConnection(_connectionString))
            {
                ...
                using (var command1 = new FbCommand("SELECT " + StatusCount.ColumnName_RunningCount + " FROM " + Core.Db.StatusCount.DocumentName + ";", conn))
                {
                    ...
                    using (var command2 = new FbCommand("UPDATE " + Core.Db.StatusCount.DocumentName + " SET " + StatusCount.ColumnName_RunningCount + " = " + count + ";", conn))
                    {
                        command2.ExecuteNonQuery();
                    }
                }
        ...
        public override void IncrementDisabledCount()
        {
            using (var conn = new FbConnection(_connectionString))
            {
                ...
                using (var command1 = new FbCommand("SELECT " + StatusCount.ColumnName_DisabledCount + " FROM " + Core.Db.StatusCount.DocumentName + ";", conn))
                {
                    ...
                    using (var command2 = new FbCommand("UPDATE " + Core.Db.StatusCount.DocumentName + " SET " + StatusCount.ColumnName_DisabledCount + " = " + count + ";", conn))
                    {
                        command2.ExecuteNonQuery();
                    }
                }
        ...
        public override void IncrementRejectedCount()
        {
            using (var conn = new FbConnection(_connectionString))
            {
                ...
                using (var command1 = new FbCommand("SELECT " + StatusCount.ColumnName_RejectedCount + " FROM " + Core.Db.StatusCount.DocumentName + ";", conn))
                {
                    ...
                    using (var command2 = new FbCommand("UPDATE " + Core.Db.StatusCount.DocumentName + " SET " + StatusCount.ColumnName_RejectedCount + " = " + count + ";", conn))
                    {
        ...
        public override void IncrementDoneCount()
        {
            using (var conn = new FbConnection(_connectionString))
            {
                ...
                using (var command1 = new FbCommand("SELECT " + StatusCount.ColumnName_DoneCount + " FROM " + Core.Db.StatusCount.DocumentName + ";", conn))
                {
                    ...
                    using (var command2 = new FbCommand("UPDATE " + Core.Db.StatusCount.DocumentName + " SET " + StatusCount.ColumnName_DoneCount + " = " + count + ";", conn))
                    {
        ...
        public override void IncrementFailedCount()
        {
            using (var conn = new FbConnection(_connectionString))
            {
                ...
                using (var command1 = new FbCommand("SELECT " + StatusCount.ColumnName_FailedCount + " FROM " + Core.Db.StatusCount.DocumentName + ";", conn))
                {
                    ...
                    using (var command2 = new FbCommand("UPDATE " + Core.Db.StatusCount.DocumentName + " SET " + StatusCount.ColumnName_FailedCount + " = " + count + ";", conn))
                    {
                        command2.ExecuteNonQuery();
                    }
                }
        ...
        public override void IncrementStoppedCount()
        {
            using (var conn = new FbConnection(_connectionString))
            {
                ...
                using (var command1 = new FbCommand("SELECT " + StatusCount.ColumnName_StoppedCount + " FROM " + Core.Db.StatusCount.DocumentName + ";", conn))
                {
                    ...
                    using (var command2 = new FbCommand("UPDATE " + Core.Db.StatusCount.DocumentName + " SET " + StatusCount.ColumnName_StoppedCount + " = " + count + ";", conn))
                    {
        ...
        public override void IncrementWarningCount()
        {
            using (var conn = new FbConnection(_connectionString))
            {
                ...
                using (var command1 = new FbCommand("SELECT " + StatusCount.ColumnName_WarningCount + " FROM " + Core.Db.StatusCount.DocumentName + ";", conn))
                {
                    ...
                    using (var command2 = new FbCommand("UPDATE " + Core.Db.StatusCount.DocumentName + " SET " + StatusCount.ColumnName_WarningCount + " = " + count + ";", conn))
                    {
