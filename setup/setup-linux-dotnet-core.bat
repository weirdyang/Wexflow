...
copy dotnet-core\linux\Oracle\appsettings.json %dstDir%\Wexflow.Scripts.Oracle
...
copy dotnet-core\linux\MariaDB\appsettings.json %dstDir%\Wexflow.Scripts.MariaDB
